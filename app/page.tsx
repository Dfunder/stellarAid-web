        ...
        <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-2 lg:text-left gap-8">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
              <li>
                Global <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">Toaster</code> in
                root layout
              </li>
          ...
          <div className="mt-8 p-4 bg-gray-100 dark:bg-gray-800 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div>
                ...
                <span
                  className={`font-medium ${env.isDevelopment ? 'text-green-600' : 'text-blue-600'}`}
                >
          ...
          <div className="mt-8 p-6 bg-gray-50 dark:bg-gray-900 rounded-lg">
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center gap-4">
                <ButtonSpinner isLoading={isButtonLoading} onClick={handleButtonLoading}>
                  Click to Load
                </ButtonSpinner>
                <button
          ...
          <div className="bg-gray-50 dark:bg-gray-900 p-6 rounded-lg">
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-400">
              ...
              <li>
                <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">
                  app/components/common/FullPageLoader.tsx
                </code>{' '}
              ...
              <li>
                <code className="bg-gray-200 dark:bg-gray-700 px-1 rounded">utils/toast.ts</code> -
                Toast helpers
              </li>
              <li>
