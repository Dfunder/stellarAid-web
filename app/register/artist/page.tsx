      ...
      <div className="max-w-lg w-full">
        <div className="bg-white dark:bg-neutral-800 rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-neutral-900 dark:text-white">Artist Registration</h1>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1.5">Portfolio URL (optional)</label>
              <input
                type="url"
            ...
            <div>
              <label className="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-1.5">Bio (optional)</label>
              <textarea
                {...register('bio')}
                rows={3}
